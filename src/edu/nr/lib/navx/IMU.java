...
public class IMU extends SensorBase implements PIDSource, LiveWindowSendable, Runnable {
	 ...
	 */
	public float getYaw() {
		float calculated_yaw = (float) (yaw - user_yaw_offset);
	...
	public boolean isConnected() {
		double time_since_last_update = Timer.getFPGATimestamp() - last_update_time;
	...
	public boolean isCalibrating() {
		short calibration_state = (short) (flags & IMUProtocol.NAV6_FLAG_MASK_CALIBRATION_STATE);
